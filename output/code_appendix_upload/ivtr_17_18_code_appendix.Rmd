---
title: "IVTR 17-18 үр дүнг гаргахад ашигласан R код"
...
Энэ Rmd-д зөвхөн final 17-18 threshold IVTR үр дүн болон түүний графикуудыг гаргахад ашигласан R кодыг оруулав. Кодыг хавсралтад харуулах зорилготой тул chunk-үүд `eval=FALSE`; knit хийхэд код харагдана, bootstrap/estimation дахин ажиллахгүй.

Оруулсан кодын дараалал:

1. `R/28_student_teacher_avg_17_18_ch_parallel_bootstrap.R`
2. `R/30_academic_figures.R`
